...
import { resumeExtractor, skipExtractor } from "@/app/actions/resumeExtractor";
  ...
  return (
    <div className="relative w-full max-w-2xl group">
      ...
      >
        ...
        <button onClick={() => {skipExtractor()}}className="text-white/70 hover:text-white underline-offset-4 hover:underline transition-colors text-sm font-medium mb-12 cursor-pointer">
